    ...
    If *sound 
      *sound\type = type 
      ...
      Else 
        ...
        *sound\sndh_mem = AllocateMemory(32000)
...
CompilerIf #PB_Compiler_IsMainFile  
  ...
  Debug FileSize("decade_demo-loader.sndh")
  
  
  ;sound = YMLoad("Decade3DDots.ym",#YM) 
  sound1 = YMLoad("decade_demo-loader.sndh",#SNDH) 
  If sound1 
    Debug "play" 
    YMplay(sound1)
  Else 
